...
echo ""
echo "Commands:"
echo "  Manual run  : .venv/bin/python -m gcal_epd.main --display"
echo "                (NOT 'systemctl start' — that unit powers the Pi off"
echo "                 when it finishes, by design for the timer.)"
